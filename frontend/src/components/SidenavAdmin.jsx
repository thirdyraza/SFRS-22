...
import { getHeadNotifs, getDeanNotifs, getOsasNotifs, reset } from '../features/notifs/notifSlice';
    ...
    <div class="main">
        ...
        <div id='sidebar'>
            ...
            <div class="links-cont">
                ...
                <Link to="./user-request-list" class="links">
                ...
                <Link to="./notifications" class="links">
