...
const { getReserves, setReserve, updateReserve, deleteReserve, getAllReserves, getReservation, getForReview, getForCheck, getForDean, getForOsas, getForOsasDash, getForDeanDash, getReservesDash, getForReviewDash, getForCheckDash, getApproved, getCancelled, getDenied, getSorted} = require('../controllers/reserveController')
...
router.route('/approved').get(protect, getApproved)
router.route('/cancelled').get(protect, getCancelled)
router.route('/denied').get(protect, getDenied)
router.route('/sorted').get(getSorted)
